...
def monthly_reports(mywin):
	...
	def select():
		...
		#Report1 = reports.ReportUsage(mymonth, myyear, 1)
		Report2 = reports.ReportUsage(mymonth, myyear, 0)
		Report3 = reports.ReportMemberUse(mymonth, myyear)
		ChargesFile = create_charges_file.CreateChargesFile(mymonth, myyear)
		...
		email_functions.send_reports([Report2, Report3])
...
def member_usage_log(mywin):
	...
	def select():
		...
		Success = reports.MemberUseLog(my_member_id)
