...
# below function will be retained but no longer used.  Code moved to 
#   weekly_csv_backups.py and executed via cron.
#
def export_excel():
...
# removed code to auto backup with import.  That code was moved to 
#   monthly_backup.py and is executede via cron.